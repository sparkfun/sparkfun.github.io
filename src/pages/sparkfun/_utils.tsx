...
import type { TagType, User } from '@site/src/data/sfe_repos';
import { sortedUsers } from '@site/src/data/sfe_repos';
...
function filterUsers({
    ...
    return users.filter((user) => {
        ...
        if (operator === 'AND') {
            return tags.every((tag) => user.topics.includes(tag));
        }
        return tags.some((tag) => user.topics.includes(tag));
    });
}
