...
import { sortedUsers, type User } from '@site/src/data/sfe_repos';
...
const otherUsers = sortedUsers.filter(
    (user) => !user.topics.includes('favorite'),
);
...
function HeadingAllSites() {
    return (
        <Heading as="h2">
            <Translate id="showcase.usersList.allUsers">All Documentation</Translate>
        </Heading>
    );
}
